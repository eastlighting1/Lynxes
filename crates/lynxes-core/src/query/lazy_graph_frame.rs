...
use crate::{
    query::executor::{execute, ExecutionValue},
    query::Connector,
    AggExpr, EdgeFrame, EdgeTypeSpec, Expr, GFError, GraphFrame, LogicalPlan, NodeFrame,
    Optimizer, OptimizerOptions, Pattern, PatternStep, Result,
};
...
impl LazyGraphFrame {
    ...
    pub fn expand(self, edge_type: EdgeTypeSpec, hops: u32, direction: crate::Direction) -> Self {
        Self::with_source(
            LogicalPlan::Expand {
                input: Box::new(self.plan),
                edge_type,
