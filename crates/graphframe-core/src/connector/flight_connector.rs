...
use arrow_flight::{
    ...
    utils::{flight_data_to_batches, ipc_message_from_arrow_schema},
...
impl FlightService for FlightGraphService {
    ...
    async fn get_schema(
        ...
        let schema = ipc_message_from_arrow_schema(&schema, &arrow_ipc::writer::IpcWriteOptions::default())
